...
Cypress.Commands.add("test", function (name) {
    var url = Scim2Constants.SCIM2_ENDPOINT;
    cy.log(url);
    cy.log(name);
});
/**
 ...
 * */
Cypress.Commands.add("createUserWithScim", function (host, authrzUserName, authrzPassword, reqBody, failOnStatusCode) {
    if (failOnStatusCode === void 0) { failOnStatusCode = true; }
    return cy.request({
        "method": "POST",
...
//# sourceMappingURL=scim2.0-user-managment.js.map